<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="yorumlar.aspx.cs" Inherits="foodwebsite.yorumlar" %>
     ...
     <asp:Panel ID="Panel1" runat="server" ForeColor="#571B8A"> 
        <table class="nav-justified" style="margin-left:10px; margin-top:10px">
            <tr>
                ...
                <td class="text-left" style="font-size: large; text-decoration: underline"><strong><em>ONAYLANMAYAN YORUMLAR</em></strong></td>
            </tr>
        </table>
                ...
                <table class="nav-justified" style="margin-left:10px;">
                    <tr>
                        <td class="text-left" style="height: 20px; width: 285px">
                            <strong>
                            <asp:Label ID="Label12" runat="server" style="font-size: 16px" Text='<%# Eval("yorumadsoyad") %>'></asp:Label>
                            </strong>
                        </td>
                        <td class="text-right" style="height: 20px">
                            &nbsp;</td>
                        <td class="text-right" style="height: 20px">
                        <a href="yorumdetay.aspx?yorumid=<%# Eval("yorumid") %>"><asp:Image ID="Image2" runat="server" Height="30px" ImageUrl="~/iconlar/update.png" Width="30px" /></a> 
                        </td>
                    </tr>
                </table>
            </ItemTemplate>
     ...
     <asp:Panel ID="Panel3" runat="server" ForeColor="#571B8A"> 
        <table class="nav-justified" style="margin-left:10px; margin-top:10px;">
            <tr>
                ...
                <td class="text-left" style="font-size: large; text-decoration: underline"><strong><em>ONAYLANAN YORUMLAR</em></strong></td>
            </tr>
        </table>
